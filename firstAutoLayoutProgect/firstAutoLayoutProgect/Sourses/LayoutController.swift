...
final class LayoutController: UIViewController {
    ...
    private lazy var mainView: UILabel = {
    ...
    override func viewDidLoad() {
        ...
        anchorHelper(label: introButtonTab, parentLabel: view, topAnchorLabel: tabBarView.topAnchor, bottomAnchorLabel: tabBarView.bottomAnchor, leadingAnchorLabel: tabBarView.leadingAnchor, trailingAnchorLabel: tabBarView.trailingAnchor, topAnchor: 8, leadingConstant: 8, trailingConstant: -273.5, widthConstant: nil, heightConstant: 36, bottomAnchor: nil, backgroundColor: .orange)
        
        anchorHelper(label: ingredientsButtonTab, parentLabel: view, topAnchorLabel: tabBarView.topAnchor, bottomAnchorLabel: nil, leadingAnchorLabel: tabBarView.leadingAnchor, trailingAnchorLabel:tabBarView.trailingAnchor, topAnchor: 8, leadingConstant: 132, trailingConstant: -132, widthConstant: nil, heightConstant: 36, bottomAnchor: nil)

        anchorHelper(label: stepsButtonTab, parentLabel: view, topAnchorLabel: tabBarView.topAnchor, bottomAnchorLabel: nil, leadingAnchorLabel: tabBarView.leadingAnchor, trailingAnchorLabel: tabBarView.trailingAnchor, topAnchor: 8, leadingConstant: 273.5, trailingConstant: -8, widthConstant: nil, heightConstant: 36, bottomAnchor: nil)
        
        // MARK: Main Lable/Frame 73
        anchorHelper(label: mainView, parentLabel: contView, topAnchorLabel: tabBarView.bottomAnchor, bottomAnchorLabel: nil, leadingAnchorLabel: contView.leadingAnchor, trailingAnchorLabel: contView.trailingAnchor, topAnchor: 2.5, leadingConstant: 0, trailingConstant: 0, widthConstant: nil, heightConstant: 898.53, bottomAnchor: nil)
        ...
        anchorHelper(label: imageButtonTab, parentLabel: view, topAnchorLabel: imageView.topAnchor, bottomAnchorLabel: nil, leadingAnchorLabel: nil, trailingAnchorLabel: imageView.trailingAnchor, topAnchor: 17, leadingConstant: nil, trailingConstant: -15.45, widthConstant: 48, heightConstant: 48, bottomAnchor: nil)
